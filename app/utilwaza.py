        ...
        try :
            if self.db != None :
                ...
                if state == 'VALIDATING_IDENTITY' and photo != None and ci_front != None and action_img != None and action_str != None :
                    ...
                    url_verification = 'http://api.jonnattan.cl:8001/document_verification' #CAMBIAR POR ENDPOINT CORRECTO
                    try :
                        ...
                        if response.status_code != None and response.status_code == 200 :
                            ...
                            url_verification = 'http://api.jonnattan.cl:8001/user_verification' #CAMBIAR POR ENDPOINT CORRECTO
